...
public class
socketSession extends SessionImpl implements socketDebugFlags {
...
/**
 * <A NAME="SD_SOCKETSESSION"></A>
 * <EM>socketSession</EM> the default constructor for the socketSession class.
 * Note that the session name is supplied by _createProxy or _createServer.
 */

    public
    socketSession() {
        if (socketSession_Debug) {
            debug("socketSession: constructor.");
        }
    }


    public
    socketSession(String name) {
        if (socketSession_Debug) {
            debug("socketSession: constructor:" +
                  " name: " + name);
        }
 ...
 */
    ...
    _createProxy(NamingProxy namingProxy, String url, String name,
        ...
        if (socketSession_Debug) {
            debug("socketSession: _createProxy:" +
 ...
 */
    ...
    _createServer(String name, short sessionNo, String connectionType,
        ...
        if (socketSession_Debug) {
            debug("socketSession: _createServer:" +
                  " object name: "     + name +
                  " session #: "       + sessionNo +
                  " connection type: " + connectionType +
                  " url: "             + url +
