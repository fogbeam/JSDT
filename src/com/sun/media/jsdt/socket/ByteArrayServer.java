 ...
 */
    ...
    private void
    informByteArrayListeners(int id, ByteArrayImpl sba, String clientName,
    ...
    join(Message message) {
        ...
        if (retval == 0) {
            informListeners(session.getName(), clientName,
                            name, ByteArrayEvent.JOINED, message.type);
...
/**
 * <A NAME="SD_LEAVE"></A>
 * <EM>leave</EM> the given client is leaving this byte array. If the
 * byte array.
 *
 ...
 */
    ...
    leave(Message message, String clientName) {
        ...
        super.leave(message, session.getName(),
                    ByteArrayImpl.M_ByteArray, clientName);
    }
 ...
 */
    ...
    setValue(Message message) {
        ...
        if (retval == 0) {
            informByteArrayListeners(message.id, byteArray, clientName,
                                     name, value);
        }
    }
}
