            ...
            if (byteArray == null) {
                ...
                switch (message.action) {
                    ...
                    case T_Join:                          // JOIN.
                        ...
                        break;
                    case T_Leave:                         // LEAVE.
                        bas.leave(message, in.readUTF(), false);
                        break;
            ...
            if (session == null) {
                ...
                switch (message.action) {
                    ...
                    case T_Expel:                  // EXPEL.
                        ...
                        break;
                    case T_GetMessage:             // GETMESSAGE.
                        ss.getMessage(message);
                        break;
                    ...
                    case T_Leave:                  // LEAVE.
                        in.readUTF();
                        ss.leave(message, in.readUTF(), false);
                        break;
            ...
            if (channel == null) {
                ...
                switch (message.action) {
                    ...
                    case T_Join:                          // JOIN.
                        ...
                        break;
                    case T_Leave:                         // LEAVE.
                        cs.leave(message, in.readUTF(), false);
                        break;
                    case T_ListClientNames:               // LISTCLIENTNAMES.
            ...
            if (token == null) {
                ...
                switch (message.action) {
                    ...
                    case T_Join:                        // JOIN.
                        ...
                        break;
                    case T_Leave:                       // LEAVE.
                        ts.leave(message, in.readUTF(), false);
                        break;
                    case T_ListClientNames:             // LISTCLIENTNAMES.
