...
class
CGIClientException extends Exception {
 ...
 */
    ...
    returnClientError(String message) {
        ...
        System.out.println("<HTML>" +
                           "<HEAD><TITLE>Java JSDT Client Error" +
                           "</TITLE></HEAD>" +
                           "<BODY>");
        System.out.println("<H1>Java JSDT Client Error</H1>");
        System.out.println("");
 ...
 */
    ...
    returnServerError(String message) {
        ...
        System.out.println("");
        System.out.println("<HTML>" +
                           "<HEAD><TITLE>Java JSDT Server Error" +
                           "</TITLE></HEAD>" +
                           "<BODY>");
        System.out.println("<H1>Java JSDT Server Error</H1>");
        System.out.println("");
        System.out.println(message);
        System.out.println("</BODY></HTML>");
        System.exit(1);
...
CGITryHostnameCommand implements CGICommandHandler {
    ...
    execute(String param) {
        ...
        System.out.println("<HTML>" +
                           ...
                           "</TITLE></HEAD>" +
                           "<BODY>");
        System.out.println("<H1>Java JSDT Server Hostname Info</H1>");
